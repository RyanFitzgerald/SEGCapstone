...
describe('Projects', () => {
  ...
  describe('/GET projects', () => {
    ...
    it('it should NOT GET all the projects with token missing', (done) => {
      chai.request(server)
        .get('/api/projects')
        .end((err, res) => {
    ...
    it('it should NOT GET all the projects with invalid token', (done) => {
      chai.request(server)
        .get(`/api/projects?access_token=123`)
        .end((err, res) => {
