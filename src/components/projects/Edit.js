                                ...
                                <form onSubmit={this.handleSubmit}>
                                    ...
                                    <div className="row">
                                        <div className="small-12 columns">
                                            ...
                                            <input type="text" ref="projectName" name="name" className="project-text-form" id="project-name" defaultValue={this.state.project.name} required />
                                        </div>
                                    </div>
                                    <div className="row">
                                        ...
                                        <div className="small-12 medium-6 columns">
                                            ...
                                            <textarea ref="projectDescription" name="description" className="project-textarea-form" id="project-description" defaultValue={this.state.project.description}></textarea>
                                        </div>
                                    </div>
                                    <div className="row">
                                        <div className="small-12 medium-4 columns">
                                            <label htmlFor="project-street">Street <span className="required">*</span></label>
                                            <input type="text" ref="street" name="street" className="project-text-form" id="project-street" defaultValue={this.state.project.street} required />
                                        </div>
                                        <div className="small-12 medium-4 columns">
                                        ...
                                        <div className="small-12 medium-4 columns">
                                            ...
                                            <select ref="city" name="city" className="client-select-form" id="client-city" defaultValue={this.state.project.city_id} required>
                                    ...
                                    <div className="row">
                                        <div className="small-12 medium-6 columns">
                                            ...
                                            <input type="text" ref="estimatedCost" name="estimatedCost" className="project-text-form" id="project-estimate" defaultValue={this.state.project.estimated_cost} />
                                        </div>
                                        <div className="small-12 medium-6 columns">
                                            <label htmlFor="project-cost">Final Cost ($)</label>
                                            <input type="text" ref="finalCost" name="finalCost" className="project-text-form" id="project-cost" defaultValue={this.state.project.final_cost} />
                                        </div>
                                    </div>
                                    <div className="row">
                                        <div className="small-12 columns">
                                            <label htmlFor="project-contract">Contract</label>
                                            <input type="file" ref="contract" name="contract" className="project-upload-form" id="project-contract" defaultValue={this.state.project.contract} />
                                        </div>
                                    </div>
                                    <div className="row">
                                        <div className="small-12 columns">
                                            <label htmlFor="project-client">Project Client <span className="required">*</span></label>
                                            <select ref="clientID" name="client" className="client-select-form" id="client-city" defaultValue={this.state.project.client_id} required>
